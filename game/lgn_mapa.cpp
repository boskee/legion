...
void MA_PRZYGODA(aint A,aint NR) {
  ...
  astr A_S="", PO_S="";
	...
	if( TYP==1 ) {																										//	   If TYP=1
		...
		RYSUJ_SCENERIE(_TEREN,-1);																			//	      RYSUJ_SCENERIE[TEREN,-1]
			//dosypujemy skarbow																					//	      'dosypujemy trochę skarbów
		IMAX=Rnd(8)+8;
	...
	if( TYP==7 ) {																										//	   If TYP=7
		...
		MAIN_ACTION();																									//	      MAIN_ACTION
																																		...
																																		//
	if( TYP==9 ) {																										//	   If TYP=9
		//---swiatynia orkow---																					//	      'świątynia orków
		...
		MAIN_ACTION();																									//	      MAIN_ACTION
																																		...
																																		//
	if( TYP==10 ) {																										//	   If TYP=10
		//---barbarzyńca na bagnach---																	//	      'barbarzyńca na bagnach
	...
	if( TYP==13 ) {																										//	   If TYP=13
																																		//	      'Goto SKIP2
		//---sparing końcowy---																					//	      'sparing końcowy
...
//			Fade 2;																											//	         Fade 2
			...
			if( WYNIK_AKCJI==1 || players[1]->playerName=="Marcin ®" ) {							//	         If WYNIK_AKCJI=1 or IMIONA$(1)="Marcin ®"
				...
				TrackLoop(true); TrackPlay(3);															//	            Track Loop On : Track Play 3
				USTAW_FONT("defender2",FONT_DEFENDER,8,1);									//	            USTAW_FONT["defender2",8]
				OUTLINE(10,200,GS("086"),1,0);															//	            OUTLINE[10,200,"Oto ten, który niszczył",1,0]
				OUTLINE(10,210,GS("087"),1,0);															//	            OUTLINE[10,210,"wszelkie życie ",1,0]
				OUTLINE(10,220,GS("088"),1,0);															//	            OUTLINE[10,220,"leży teraz martwy",1,0]
