...
void WYBOR(aint WT) {
	...
	//strefy doswiadczenia;																						//	   '--------------strefy doświadczenia
...
void A_STRZAL(aint A,aint I) {
	...
	//trafienie w goscia													//	   'trafienie w gościa
	if( STREFA>0 && STREFA!=I2 && STREFA<21 ) {		//	   If STREFA>0 and STREFA<>I2 and STREFA<21
		...
		//oszczepy laduja na glebie									//	      'oszczepy lądują na glebie
...
void PLAPKA(aint NR,aint A,aint I,aint X,aint Y) {
	...
	//---przepasc gleboka---																															//	   'przepaść głęboka
